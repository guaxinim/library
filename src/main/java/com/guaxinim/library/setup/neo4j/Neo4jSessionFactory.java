package com.guaxinim.library.setup.neo4j;
...
public class Neo4jSessionFactory {
    ...
    public Session getOGMSession() {
        ...
        SessionFactory sessionFactory = new SessionFactory(client, "com.guaxinim.library.domain");
        //SessionFactory sessionFactory = new SessionFactory(getConfiguration(), "com.guaxinim.library.domain");
